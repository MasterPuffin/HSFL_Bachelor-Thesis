...
{block "main"}
    <div class="px-4 py-5 my-5 text-center">
        <img class="d-block mx-auto mb-4" src="{constant('RESOURCESROOT')}/.assets/images/HSFL_Icon.png" alt=""
             height="100">
    ...
    <div class="px-4 pb-5 my-5 text-center">
        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                <a href="{constant('WEBROOT')}/contact/" class="btn btn-primary btn-lg px-4 gap-3">Kontakt</a>
            </div>
        </div>
    </div>
{/block}